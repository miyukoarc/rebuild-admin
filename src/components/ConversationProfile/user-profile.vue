<template>
  <div class="profile-user">
    ...
    >加入黑名单</el-button>
    <el-button v-else-if="isInBlacklist" title="将该用户移出黑名单" type="text" @click="removeFromBlacklist">移出黑名单</el-button>
    <!-- 拉黑 和 反拉黑 -->
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState({
      blacklist: state => state['im/blacklist'].blacklist,
      myUserID: state => state['im/user'].currentUserProfile.userID
    }),
    isInBlacklist() {
