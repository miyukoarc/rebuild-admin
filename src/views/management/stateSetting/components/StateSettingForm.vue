  ...
  <div>
    ...
    <div v-if="mType == AddButtonFormType.ADDBUTTONEVENT">
      ...
      >
        ...
        <el-form-item :label="stateSettings.roles" prop="roles">
          <!-- <template slot="label">
            <div class="text-align-left">{{stateSettings.roles}}</div>
          </template> -->
          <!-- <el-input v-model="addEventForm.name" placeholder></el-input> -->
          <el-select
        ...
        <el-form-item :label="stateSettings.target" prop="target">
          <!-- <el-input v-model="addEventForm.target" placeholder></el-input> -->
        ...
        <el-form-item>
          <el-button type="primary" @click="submitStateData"
            >立即创建</el-button
          >
    ...
    <div v-if="mType == AddButtonFormType.ADDBUTTONSTATE">
      ...
      >
        ...
        <el-form-item prop="stateType">
          <template slot="label">
            <div class="text-align-left">
              {{ stateSettings.stateType }}
            </div>
          </template>
          <el-select
            v-model="addStateForm.stateType"
            placeholder
        ...
        <el-collapse-transition name="slide-down">
          <div v-show="showThenAction">
            ...
            <el-form-item>
              <template slot="label">
                <div class="text-align-left">
                  {{ stateSettings.firstGuardSpel }}
                </div>
              </template>
              <el-input
                v-model="addStateForm.firstGuardSpel"
                placeholder
              ></el-input>
            </el-form-item>
            <el-form-item>
              <template slot="label">
                <div class="text-align-left">
                  {{ stateSettings.thenTarget }}
                </div>
              </template>
              <el-select
                v-model="addStateForm.thenTarget"
                placeholder="请选择目标状态"
              >
                <el-option
                  v-for="item in stateList"
            ...
            <el-form-item>
              <template slot="label">
                <div class="text-align-left">
                  {{ stateSettings.thenGuardSpel }}
                </div>
              </template>
              <el-input
                v-model="addStateForm.thenGuardSpel"
                placeholder
              ></el-input>
            </el-form-item>
            <el-form-item>
              <template slot="label">
                <div class="text-align-left">
                  {{ stateSettings.lastTarget }}
                </div>
              </template>
              <el-select
                v-model="addStateForm.lastTarget"
                placeholder="请选择目标状态"
              >
                <el-option
                  v-for="item in stateList"
    ...
    <div v-if="mType == AddButtonFormType.ADDBUTTONTIMER">
      ...
      >
        ...
        >
          <!-- <el-input
            v-model="addEventForm.timerOnce"
            placeholder
            :disabled="
              addEventForm.timerInterva != '' &&
                Number(addTimerForm.timerInterva) != 0
            "
          ></el-input> -->
          <!-- <el-input-number
            size="small"
        ...
        <el-form-item>
          ...
          <!-- <el-input v-model="addTimerForm.action" placeholder></el-input> -->
...
export default {
  ...
  computed: {
    ...mapState('stateSettings', ["roleList", "stateList", "actionList"]),
